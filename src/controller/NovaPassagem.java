...
public class NovaPassagem extends JFrame {
	...
	/**
	 * @param cidade Recebe uma cidade e verifica no banco de dados se ela já existe. 
	...
	/**
	 * Função para validar os dados digitados pelo usuário no banco de dados. Se houver campos vazios envia um pop up com aviso e 
	 * limpa os campos de texto. Se a cidade da passagem ainda não existir na tabela 'cidades', cadastra lá também. 
	 * 
	 */
